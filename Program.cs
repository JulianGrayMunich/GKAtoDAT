...
namespace GKAtoDAT
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string strNoOfSettopFolders = System.Configuration.ConfigurationManager.AppSettings["NoOfSettopFolders"];
            string strSettopFolder01 = System.Configuration.ConfigurationManager.AppSettings["SettopFolder01"];
            string strSettopFolder02 = System.Configuration.ConfigurationManager.AppSettings["SettopFolder02"];
            string strSettopFolder03 = System.Configuration.ConfigurationManager.AppSettings["SettopFolder03"];
            string strSettopFolder04 = System.Configuration.ConfigurationManager.AppSettings["SettopFolder04"];
            string strSettopFolder05 = System.Configuration.ConfigurationManager.AppSettings["SettopFolder05"];
            string strDestinationPath = System.Configuration.ConfigurationManager.AppSettings["DestinationPath"];
            string strTimekeeperPath = System.Configuration.ConfigurationManager.AppSettings["TimekeeperPath"];
            string strSourceFileExtension = System.Configuration.ConfigurationManager.AppSettings["SourceFileExtension"];
            string strOutputFileExtension = System.Configuration.ConfigurationManager.AppSettings["OutputFileExtension"];
            string strCSVseparator = System.Configuration.ConfigurationManager.AppSettings["CSVseparator"];
            string strDegRadGon = System.Configuration.ConfigurationManager.AppSettings["DegRadGon"];
            ...
            string timeToSendSystemOperationalEmail = System.Configuration.ConfigurationManager.AppSettings["SystemOperationalEmail"];
            ...
            string UpdateDataTimeStamp()
            {
                ...
                {
                    using (StreamWriter writetext = new StreamWriter(strTimekeeperFile, false))
                    {
                ...
                else
                {
                    ...
                    int iTimeLineCounter = TimeLine.Count();
            ...
            string writeConvertedObsToFile()
            {
                ...
                {
                    using (StreamWriter writetext = new StreamWriter(strOutputFile, false))
                    {
            ...
            string CreateOutputFileName()
            {
                ...
                var count = strCurrentGKAfile.Split('\\').Count();
            ...
            string computeMeanAngles()
            {
                if (strFaceFlag == "F1F2")
                {
                    ...
                    if ((dblFace2 >= 0.0) && (dblFace2 < 180.0))
                    {
                        dblFace2 = dblFace2 + 180.0;
                    }
                    else
                    {
                        dblFace2 = dblFace2 - 180.0;
                    ...
                    dblMeanVA = dblMeanVA + ((360.0 - dblFace1 - dblFace2) / 2.0);
            ...
            // Source data is in gons
                ...
                {
                    case "Deg":
                        dblConversionFactor = (180.0/200.0);
                        break;
                    case "Rad":
                        dblConversionFactor = 3.14159265358979 / 200.0;
                        break;
                    case "Gon":
                        dblConversionFactor = 1.0;
                        break;
                    default:
                        dblConversionFactor = 0.0;
                        break;
                }
            ...
            for (counter = 1; counter <= iNoOfSettopFolders; counter++)
            {
                ...
                {
                    using (StreamWriter writetext = new StreamWriter(textFile, false))
                    {
               ...
               gna.noDataAlarm(strCurrentGKAfolder, strNoDataInterval, strEmailLogin, strEmailPassword, strEmailFrom, strNoDataAlarmRecipients, testEmail);

            }

            Console.WriteLine("=====[ Processing of Settop Files Complete ]=======");
            //Console.ReadKey();
        }
    }
}
